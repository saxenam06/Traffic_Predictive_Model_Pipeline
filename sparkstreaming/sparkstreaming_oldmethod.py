...
def main():
    ...
    kafkaStream = KafkaUtils.createDirectStream(ssc, ['trafficdata'], {"metadata.broker.list": 'localhost:9092'})


    connection = psycopg2.connect(host = 'localhost', database = 'postgres', user = 'postgres', password = 'Cr@2605123')
    cursor = connection.cursor()
